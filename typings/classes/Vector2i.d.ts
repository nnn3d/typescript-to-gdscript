...
declare interface Vector2i {
   ...
   */
  clamp(min: Vector2i | Vector2, max: Vector2i | Vector2): Vector2i;
  /**
   ...
   */
  max(with_: Vector2i | Vector2): Vector2i;
  /**
   ...
   */
  min(with_: Vector2i | Vector2): Vector2i;
  /**
   ...
   */
  snapped(step: Vector2i | Vector2): Vector2i;

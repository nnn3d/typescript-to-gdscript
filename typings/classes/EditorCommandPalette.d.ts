...
declare class EditorCommandPalette extends ConfirmationDialog {
   ...
   */
  add_command(command_name: string | NodePath, key_name: string | NodePath, binded_callable: Callable, shortcut_text?: string | NodePath): void;
  /**
   * Removes the custom command from EditorCommandPalette.
   * - `key_name`: {@link String} (Name of the key for a particular **Command**.)
   */
  remove_command(key_name: string | NodePath): void;
}

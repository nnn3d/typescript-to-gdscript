...
declare interface Geometry3D extends GodotObject {
   ...
   */
  build_box_planes(extents: Vector3 | Vector3i): Array<Plane>;
  /**
   ...
   */
  clip_polygon(points: PackedVector3Array | Array<unknown>, plane: Plane): PackedVector3Array;
   ...
   */
  get_closest_point_to_segment(point: Vector3 | Vector3i, s1: Vector3 | Vector3i, s2: Vector3 | Vector3i): Vector3;
  /**
   * Returns the 3D point on the 3D line defined by (`s1`, `s2`) that is closest to `point`. The returned point can be inside the segment (`s1`, `s2`) or outside of it, i.e. somewhere on the line extending from the segment.
   */
  get_closest_point_to_segment_uncapped(point: Vector3 | Vector3i, s1: Vector3 | Vector3i, s2: Vector3 | Vector3i): Vector3;
  /**
   ...
   */
  get_closest_points_between_segments(p1: Vector3 | Vector3i, p2: Vector3 | Vector3i, q1: Vector3 | Vector3i, q2: Vector3 | Vector3i): PackedVector3Array;
  /**
   ...
   */
  get_triangle_barycentric_coords(point: Vector3 | Vector3i, a: Vector3 | Vector3i, b: Vector3 | Vector3i, c: Vector3 | Vector3i): Vector3;
  /**
   ...
   */
  ray_intersects_triangle(from_: Vector3 | Vector3i, dir: Vector3 | Vector3i, a: Vector3 | Vector3i, b: Vector3 | Vector3i, c: Vector3 | Vector3i): unknown;
  /**
   ...
   */
  segment_intersects_convex(from_: Vector3 | Vector3i, to: Vector3 | Vector3i, planes: Array<Plane>): PackedVector3Array;
  /**
   ...
   */
  segment_intersects_cylinder(from_: Vector3 | Vector3i, to: Vector3 | Vector3i, height: float, radius: float): PackedVector3Array;
  /**
   ...
   */
  segment_intersects_sphere(from_: Vector3 | Vector3i, to: Vector3 | Vector3i, sphere_position: Vector3 | Vector3i, sphere_radius: float): PackedVector3Array;
  /**
   ...
   */
  segment_intersects_triangle(from_: Vector3 | Vector3i, to: Vector3 | Vector3i, a: Vector3 | Vector3i, b: Vector3 | Vector3i, c: Vector3 | Vector3i): unknown;
  /**
   ...
   */
  tetrahedralize_delaunay(points: PackedVector3Array | Array<unknown>): PackedInt32Array;
}

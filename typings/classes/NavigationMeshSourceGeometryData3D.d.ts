...
declare class NavigationMeshSourceGeometryData3D extends Resource {
   ...
   */
  add_faces(faces: PackedVector3Array | Array<unknown>, xform: Transform3D | Projection): void;
  /**
   ...
   */
  add_mesh(mesh: Mesh, xform: Transform3D | Projection): void;
  /**
   ...
   */
  add_mesh_array(mesh_array: Array<unknown> | PackedByteArray | PackedColorArray | PackedFloat32Array | PackedFloat64Array | PackedInt32Array | PackedInt64Array | PackedStringArray | PackedVector2Array | PackedVector3Array | PackedVector4Array, xform: Transform3D | Projection): void;
  /**
   ...
   */
  add_projected_obstruction(vertices: PackedVector3Array | Array<unknown>, elevation: float, height: float, carve: boolean): void;
  /**
   ...
   */
  append_arrays(vertices: PackedFloat32Array | Array<unknown>, indices: PackedInt32Array | Array<unknown>): void;
   ...
   */
  set_indices(indices: PackedInt32Array | Array<unknown>): void;
   ...
   * **Warning:** Inappropriate data can crash the baking process of the involved third-party libraries.
   */
  set_vertices(vertices: PackedFloat32Array | Array<unknown>): void;
}

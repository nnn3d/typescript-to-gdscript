...
declare class JSONRPC extends GodotObject {
   ...
   */
  make_notification(method: string | NodePath, params: unknown): Dictionary;
  /**
   ...
   */
  make_request(method: string | NodePath, params: unknown, id: unknown): Dictionary;
  /**
   ...
   */
  make_response_error(code: int, message: string | NodePath, id?: unknown): Dictionary;
  /**
  ...
  process_string(action: string | NodePath): string;
  /**
   ...
   */
  set_method(name: string | NodePath, callback: Callable): void;

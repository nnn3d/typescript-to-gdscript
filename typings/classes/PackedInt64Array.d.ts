...
declare interface PackedInt64Array {
  ...
  append_array(array: PackedInt64Array | Array<unknown>): void;
  /**
  ...
  size(): int;
  /**
   * Returns the slice of the {@link PackedInt64Array}, from `begin` (inclusive) to `end` (exclusive), as a new {@link PackedInt64Array}.
  ...
  // Operator overloads
  [__ops_ne]: { right: PackedInt64Array; ret: boolean };

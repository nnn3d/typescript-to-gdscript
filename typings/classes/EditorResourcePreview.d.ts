...
declare class EditorResourcePreview extends Node {
  ...
  check_for_invalidation(path: string | NodePath): void;
  /**
   ...
   * **Note:** If it was not possible to create the preview the `receiver_func` will still be called, but the preview will be `null`.
   */
  queue_resource_preview(path: string | NodePath, receiver: GodotObject, receiver_func: string, userdata: unknown): void;

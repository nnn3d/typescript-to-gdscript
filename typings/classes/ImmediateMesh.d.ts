...
declare class ImmediateMesh extends Mesh {
  ...
  surface_add_vertex(vertex: Vector3 | Vector3i): void;
  /** Add a 2D vertex using the current attributes previously set. */
  surface_add_vertex_2d(vertex: Vector2 | Vector2i): void;
  /** Begin a new surface. */
  ...
  surface_set_normal(normal: Vector3 | Vector3i): void;
  /**
  ...
  surface_set_uv(uv: Vector2 | Vector2i): void;
  /** Set the UV2 attribute that will be pushed with the next vertex. */
  surface_set_uv2(uv2: Vector2 | Vector2i): void;
}

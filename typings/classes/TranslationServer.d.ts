...
declare interface TranslationServer extends GodotObject {
  ...
  compare_locales(locale_a: string | NodePath, locale_b: string | NodePath): int;
  /**
  ...
  format_number(number: string | NodePath, locale: string | NodePath): string;
  ...
  get_country_name(country: string | NodePath): string;
  /** Returns a readable language name for the `language` code. */
  get_language_name(language: string | NodePath): string;
   ...
   */
  get_locale_name(locale: string | NodePath): string;
  /**
  ...
  get_percent_sign(locale: string | NodePath): string;
  /** Returns the default plural rules for the `locale`. */
  get_plural_rules(locale: string | NodePath): string;
  /** Returns a readable script name for the `script` code. */
  get_script_name(script: string | NodePath): string;
  /**
  ...
  parse_number(number: string | NodePath, locale: string | NodePath): string;
  /**
   ...
   */
  set_locale(locale: string | NodePath): void;
  /**
   ...
   */
  standardize_locale(locale: string | NodePath, add_defaults?: boolean): string;
  /**

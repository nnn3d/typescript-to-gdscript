...
declare class TileSetAtlasSource extends TileSetSource {
  ...
  set_margins(value: Vector2i | Vector2): void;
  get_margins(): Vector2i;
  set_separation(value: Vector2i | Vector2): void;
  get_separation(): Vector2i;
  set_texture(value: Texture2D | null): void;
  get_texture(): Texture2D | null;
  set_texture_region_size(value: Vector2i | Vector2): void;
   ...
   */
  create_alternative_tile(atlas_coords: Vector2i | Vector2, alternative_id_override?: int): int;
  /** Creates a new tile at coordinates `atlas_coords` with the given `size`. */
  create_tile(atlas_coords: Vector2i | Vector2, size?: Vector2i | Vector2): void;
  /**
  ...
  get_next_alternative_tile_id(atlas_coords: Vector2i | Vector2): int;
  /**
   ...
   */
  get_tile_animation_total_duration(atlas_coords: Vector2i | Vector2): float;
  /**
   ...
   */
  get_tile_at_coords(atlas_coords: Vector2i | Vector2): Vector2i;
  /** Returns the {@link TileData} object for the given atlas coordinates and alternative ID. */
  get_tile_data(atlas_coords: Vector2i | Vector2, alternative_tile: int): TileData | null;
  /** Returns the size of the tile (in the grid coordinates system) at coordinates `atlas_coords`. */
  get_tile_size_in_atlas(atlas_coords: Vector2i | Vector2): Vector2i;
  /**
   ...
   */
  get_tile_texture_region(atlas_coords: Vector2i | Vector2, frame?: int): Rect2i;
  /**
   ...
   */
  get_tiles_to_be_removed_on_change(texture: Texture2D, margins: Vector2i | Vector2, separation: Vector2i | Vector2, texture_region_size: Vector2i | Vector2): PackedVector2Array;
  /**
   ...
   */
  has_room_for_tile(atlas_coords: Vector2i | Vector2, size: Vector2i | Vector2, animation_columns: int, animation_separation: Vector2i | Vector2, frames_count: int, ignored_tile?: Vector2i | Vector2): boolean;
  /**
   ...
   */
  move_tile_in_atlas(atlas_coords: Vector2i | Vector2, new_atlas_coords?: Vector2i | Vector2, new_size?: Vector2i | Vector2): void;
  /**
   ...
   */
  remove_alternative_tile(atlas_coords: Vector2i | Vector2, alternative_tile: int): void;
  /** Remove a tile and its alternative at coordinates `atlas_coords`. */
  remove_tile(atlas_coords: Vector2i | Vector2): void;
  /**
   ...
   */
  set_alternative_tile_id(atlas_coords: Vector2i | Vector2, alternative_tile: int, new_id: int): void;
  /**
   ...
   */
  set_tile_animation_columns(atlas_coords: Vector2i | Vector2, frame_columns: int): void;
  /**
   * Sets the animation frame `duration` of frame `frame_index` for the tile at coordinates `atlas_coords`.
   */
  set_tile_animation_frame_duration(atlas_coords: Vector2i | Vector2, frame_index: int, duration: float): void;
  /** Sets how many animation frames the tile at coordinates `atlas_coords` has. */
  set_tile_animation_frames_count(atlas_coords: Vector2i | Vector2, frames_count: int): void;
  /**
   * Sets the tile animation mode of the tile at `atlas_coords` to `mode`. See also {@link get_tile_animation_mode}.
   */
  set_tile_animation_mode(atlas_coords: Vector2i | Vector2, mode: int): void;
  /**
   * Sets the margin (in grid tiles) between each tile in the animation layout of the tile at coordinates `atlas_coords` has.
   */
  set_tile_animation_separation(atlas_coords: Vector2i | Vector2, separation: Vector2i | Vector2): void;
  /** Sets the animation speed of the tile at coordinates `atlas_coords` has. */
  set_tile_animation_speed(atlas_coords: Vector2i | Vector2, speed: float): void;

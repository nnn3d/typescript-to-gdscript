...
declare class NavigationLink3D extends Node3D {
  ...
  /**
   * Whether this link is currently active. If `false`, {@link NavigationServer3D.map_get_path} will ignore this link.
   */
  enabled: boolean;
  /**
   * Ending position of the link.
   * This position will search out the nearest polygon in the navigation mesh to attach to.
   * The distance the link will search is controlled by {@link NavigationServer3D.map_set_link_connection_radius}.
   */
  ...
  enter_cost: float;
  /**
   * A bitfield determining all navigation layers the link belongs to. These navigation layers will be checked when requesting a path with {@link NavigationServer3D.map_get_path}.
   */
  ...
  /**
   * Sets the {@link RID} of the navigation map this link should use. By default the link will automatically join the {@link World3D} default navigation map so this function is only required to override the default map.
   */

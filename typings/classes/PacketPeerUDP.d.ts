...
declare class PacketPeerUDP extends PacketPeer {
   ...
   */
  bind(port: int, bind_address?: string | NodePath, recv_buf_size?: int): int;
   ...
   */
  join_multicast_group(multicast_address: string | NodePath, interface_name: string | NodePath): int;
  /**
   * Removes the interface identified by `interface_name` from the multicast group specified by `multicast_address`.
   */
  leave_multicast_group(multicast_address: string | NodePath, interface_name: string | NodePath): int;
  /**
   ...
   */
  set_dest_address(host: string | NodePath, port: int): int;
  /**

...
declare class TileSetSource extends Resource {
  ...
  get_alternative_tile_id(atlas_coords: Vector2i | Vector2, index: int): int;
  /**
   ...
   */
  get_alternative_tiles_count(atlas_coords: Vector2i | Vector2): int;
   ...
   */
  has_alternative_tile(atlas_coords: Vector2i | Vector2, alternative_tile: int): boolean;
  /** Returns if this atlas has a tile with coordinates ID `atlas_coords`. */
  has_tile(atlas_coords: Vector2i | Vector2): boolean;
}

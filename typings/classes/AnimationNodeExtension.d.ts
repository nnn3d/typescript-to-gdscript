...
declare class AnimationNodeExtension extends AnimationNode {
   ...
   */
  _process_animation_node(playback_info: PackedFloat64Array | Array<unknown>, test_only: boolean): PackedFloat32Array;
  /**
   ...
   */
  static get_remaining_time(node_info: PackedFloat32Array | Array<unknown>, break_loop: boolean): float;
  /** Returns `true` if the animation for the given `node_info` is looping. */
  static is_looping(node_info: PackedFloat32Array | Array<unknown>): boolean;
}

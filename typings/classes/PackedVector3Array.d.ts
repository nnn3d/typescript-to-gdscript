...
declare interface PackedVector3Array {
  ...
  append(value: Vector3 | Vector3i): boolean;
  /** Appends a {@link PackedVector3Array} at the end of this array. */
  append_array(array: PackedVector3Array | Array<unknown>): void;
  /**
   ...
   */
  bsearch(value: Vector3 | Vector3i, before?: boolean): int;
   ...
   * **Note:** Vectors with {@link @GDScript.NAN} elements don't behave the same as other vectors. Therefore, the results from this method may not be accurate if NaNs are included.
   */
  count(value: Vector3 | Vector3i): int;
   ...
   * **Note:** Vectors with {@link @GDScript.NAN} elements don't behave the same as other vectors. Therefore, the results from this method may not be accurate if NaNs are included.
   */
  erase(value: Vector3 | Vector3i): boolean;
  /**
   ...
   */
  fill(value: Vector3 | Vector3i): void;
  /**
   * Searches the array for a value and returns its index or `-1` if not found. Optionally, the initial search index can be passed.
   * **Note:** Vectors with {@link @GDScript.NAN} elements don't behave the same as other vectors. Therefore, the results from this method may not be accurate if NaNs are included.
   */
  find(value: Vector3 | Vector3i, from_?: int): int;
  /**
   * Returns the {@link Vector3} at the given `index` in the array. If `index` is out-of-bounds or negative, this method fails and returns `Vector3(0, 0, 0)`.
   ...
   * **Note:** Vectors with {@link @GDScript.NAN} elements don't behave the same as other vectors. Therefore, the results from this method may not be accurate if NaNs are included.
   */
  has(value: Vector3 | Vector3i): boolean;
  /**
   * Inserts a new element at a given position in the array. The position must be valid, or at the end of the array (`idx == size()`).
   */
  insert(at_index: int, value: Vector3 | Vector3i): int;
  /** Returns `true` if the array is empty. */
  is_empty(): boolean;
  /** Inserts a {@link Vector3} at the end. */
  push_back(value: Vector3 | Vector3i): boolean;
   ...
   * **Note:** Vectors with {@link @GDScript.NAN} elements don't behave the same as other vectors. Therefore, the results from this method may not be accurate if NaNs are included.
   */
  rfind(value: Vector3 | Vector3i, from_?: int): int;
  /** Changes the {@link Vector3} at the given index. */
  set(index: int, value: Vector3 | Vector3i): void;
  /** Returns the number of elements in the array. */
  size(): int;
  /**
   * Returns the slice of the {@link PackedVector3Array}, from `begin` (inclusive) to `end` (exclusive), as a new {@link PackedVector3Array}.
   ...
   */
  sort(): void;
  /** Returns a {@link PackedByteArray} with each vector encoded as bytes. */

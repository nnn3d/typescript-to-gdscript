...
declare class ParticleProcessMaterial extends Material {
  ...
  set_direction(value: Vector3 | Vector3i): void;
  get_direction(): Vector3;
  set_emission_box_extents(value: Vector3 | Vector3i): void;
  ...
  set_emission_ring_axis(value: Vector3 | Vector3i): void;
  ...
  set_emission_shape_offset(value: Vector3 | Vector3i): void;
  get_emission_shape_offset(): Vector3;
  set_emission_shape_scale(value: Vector3 | Vector3i): void;
  ...
  set_turbulence_noise_speed(value: Vector3 | Vector3i): void;
   ...
   */
  set_param(param: int, value: Vector2 | Vector2i): void;

...
interface PackedVector4Array {
  ...
  size(): int;
  /**
   * Returns the slice of the {@link PackedVector4Array}, from `begin` (inclusive) to `end` (exclusive), as a new {@link PackedVector4Array}.
...
interface PackedVector4ArrayConstructor {

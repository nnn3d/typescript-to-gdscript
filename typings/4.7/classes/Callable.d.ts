...
declare interface CallableFunction extends Function {
  ...
  bind<Init extends any[], L1, L2, L3, L4, R>(this: (...args: [...Init, L1, L2, L3, L4]) => R, arg1: L1, arg2: L2, arg3: L3, arg4: L4): (...args: Init) => R;
  bind<Init extends any[], L1, L2, L3, L4, L5, R>(this: (...args: [...Init, L1, L2, L3, L4, L5]) => R, arg1: L1, arg2: L2, arg3: L3, arg4: L4, arg5: L5): (...args: Init) => R;
  bind(...args: any[]): Callable;
  bindv<F>(this: F, args: []): F;
  bindv<Init extends any[], L, R>(this: (...args: [...Init, L]) => R, args: [L]): (...args: Init) => R;
  bindv<Init extends any[], L1, L2, R>(this: (...args: [...Init, L1, L2]) => R, args: [L1, L2]): (...args: Init) => R;
  bindv<Init extends any[], L1, L2, L3, R>(this: (...args: [...Init, L1, L2, L3]) => R, args: [L1, L2, L3]): (...args: Init) => R;
  bindv<Init extends any[], L1, L2, L3, L4, R>(this: (...args: [...Init, L1, L2, L3, L4]) => R, args: [L1, L2, L3, L4]): (...args: Init) => R;
  bindv<Init extends any[], L1, L2, L3, L4, L5, R>(this: (...args: [...Init, L1, L2, L3, L4, L5]) => R, args: [L1, L2, L3, L4, L5]): (...args: Init) => R;
  bindv(args: Array<any>): Callable;

...
declare class Environment extends Resource {
  ...
  set_adjustment_saturation(value: float): void;
  get_adjustment_saturation(): float;
  set_ambient_light_color(value: Color): void;
  get_ambient_light_color(): Color;
  set_ambient_light_energy(value: float): void;
  get_ambient_light_energy(): float;
  set_ambient_light_sky_contribution(value: float): void;
  get_ambient_light_sky_contribution(): float;
  set_ambient_source(value: int): void;
  get_ambient_source(): int;
  set_camera_feed_id(value: int): void;
  get_camera_feed_id(): int;
  set_canvas_max_layer(value: int): void;
  get_canvas_max_layer(): int;
  set_bg_color(value: Color): void;
  get_bg_color(): Color;
  set_bg_energy_multiplier(value: float): void;
  get_bg_energy_multiplier(): float;
  set_bg_intensity(value: float): void;
  get_bg_intensity(): float;
  set_background(value: int): void;
  get_background(): int;
  set_fog_aerial_perspective(value: float): void;
  get_fog_aerial_perspective(): float;
  set_fog_density(value: float): void;
  get_fog_density(): float;
  set_fog_depth_begin(value: float): void;
  get_fog_depth_begin(): float;
  set_fog_depth_curve(value: float): void;
  get_fog_depth_curve(): float;
  set_fog_depth_end(value: float): void;
  get_fog_depth_end(): float;
  set_fog_enabled(value: boolean): void;
  is_fog_enabled(): boolean;
  set_fog_height(value: float): void;
  get_fog_height(): float;
  set_fog_height_density(value: float): void;
  get_fog_height_density(): float;
  set_fog_light_color(value: Color): void;
  get_fog_light_color(): Color;
  set_fog_light_energy(value: float): void;
  get_fog_light_energy(): float;
  set_fog_mode(value: int): void;
  get_fog_mode(): int;
  set_fog_sky_affect(value: float): void;
  get_fog_sky_affect(): float;
  set_fog_sun_scatter(value: float): void;
  get_fog_sun_scatter(): float;
  set_glow_blend_mode(value: int): void;
  get_glow_blend_mode(): int;
  set_glow_bloom(value: float): void;
  get_glow_bloom(): float;
  set_glow_enabled(value: boolean): void;
  is_glow_enabled(): boolean;
  set_glow_hdr_luminance_cap(value: float): void;
  get_glow_hdr_luminance_cap(): float;
  set_glow_hdr_bleed_scale(value: float): void;
  get_glow_hdr_bleed_scale(): float;
  set_glow_hdr_bleed_threshold(value: float): void;
  ...
  get_glow_mix(): float;
  set_glow_normalized(value: boolean): void;
  is_glow_normalized(): boolean;
  set_glow_strength(value: float): void;
  get_glow_strength(): float;
  set_reflection_source(value: int): void;
  get_reflection_source(): int;
  set_sdfgi_bounce_feedback(value: float): void;
  get_sdfgi_bounce_feedback(): float;
  set_sdfgi_cascade0_distance(value: float): void;
  get_sdfgi_cascade0_distance(): float;
  set_sdfgi_cascades(value: int): void;
  get_sdfgi_cascades(): int;
  set_sdfgi_enabled(value: boolean): void;
  is_sdfgi_enabled(): boolean;
  set_sdfgi_energy(value: float): void;
  get_sdfgi_energy(): float;
  set_sdfgi_max_distance(value: float): void;
  get_sdfgi_max_distance(): float;
  set_sdfgi_min_cell_size(value: float): void;
  get_sdfgi_min_cell_size(): float;
  set_sdfgi_normal_bias(value: float): void;
  get_sdfgi_normal_bias(): float;
  set_sdfgi_probe_bias(value: float): void;
  get_sdfgi_probe_bias(): float;
  set_sdfgi_read_sky_light(value: boolean): void;
  is_sdfgi_reading_sky_light(): boolean;
  set_sdfgi_use_occlusion(value: boolean): void;
  ...
  set_ssao_detail(value: float): void;
  get_ssao_detail(): float;
  set_ssao_enabled(value: boolean): void;
  is_ssao_enabled(): boolean;
  set_ssao_horizon(value: float): void;
  get_ssao_horizon(): float;
  set_ssao_intensity(value: float): void;
  get_ssao_intensity(): float;
  set_ssao_direct_light_affect(value: float): void;
  get_ssao_direct_light_affect(): float;
  set_ssao_power(value: float): void;
  get_ssao_power(): float;
  set_ssao_radius(value: float): void;
  get_ssao_radius(): float;
  set_ssao_sharpness(value: float): void;
  get_ssao_sharpness(): float;
  set_ssil_enabled(value: boolean): void;
  is_ssil_enabled(): boolean;
  set_ssil_intensity(value: float): void;
  get_ssil_intensity(): float;
  set_ssil_normal_rejection(value: float): void;
  get_ssil_normal_rejection(): float;
  set_ssil_radius(value: float): void;
  get_ssil_radius(): float;
  set_ssil_sharpness(value: float): void;
  get_ssil_sharpness(): float;
  set_ssr_depth_tolerance(value: float): void;
  get_ssr_depth_tolerance(): float;
  set_ssr_enabled(value: boolean): void;
  is_ssr_enabled(): boolean;
  set_ssr_fade_in(value: float): void;
  get_ssr_fade_in(): float;
  set_ssr_fade_out(value: float): void;
  get_ssr_fade_out(): float;
  set_ssr_max_steps(value: int): void;
  get_ssr_max_steps(): int;
  set_tonemap_agx_contrast(value: float): void;
  get_tonemap_agx_contrast(): float;
  set_tonemap_agx_white(value: float): void;
  get_tonemap_agx_white(): float;
  set_tonemap_exposure(value: float): void;
  get_tonemap_exposure(): float;
  set_tonemapper(value: int): void;
  get_tonemapper(): int;
  set_tonemap_white(value: float): void;
  get_tonemap_white(): float;
  set_volumetric_fog_albedo(value: Color): void;
  get_volumetric_fog_albedo(): Color;
  set_volumetric_fog_ambient_inject(value: float): void;
  get_volumetric_fog_ambient_inject(): float;
  set_volumetric_fog_anisotropy(value: float): void;
  get_volumetric_fog_anisotropy(): float;
  set_volumetric_fog_density(value: float): void;
  get_volumetric_fog_density(): float;
  set_volumetric_fog_detail_spread(value: float): void;
  get_volumetric_fog_detail_spread(): float;
  set_volumetric_fog_emission(value: Color): void;
  get_volumetric_fog_emission(): Color;
  set_volumetric_fog_emission_energy(value: float): void;
  get_volumetric_fog_emission_energy(): float;
  set_volumetric_fog_enabled(value: boolean): void;
  is_volumetric_fog_enabled(): boolean;
  set_volumetric_fog_gi_inject(value: float): void;
  get_volumetric_fog_gi_inject(): float;
  set_volumetric_fog_length(value: float): void;
  get_volumetric_fog_length(): float;
  set_volumetric_fog_sky_affect(value: float): void;
  get_volumetric_fog_sky_affect(): float;
  set_volumetric_fog_temporal_reprojection_amount(value: float): void;
  get_volumetric_fog_temporal_reprojection_amount(): float;
  set_volumetric_fog_temporal_reprojection_enabled(value: boolean): void;

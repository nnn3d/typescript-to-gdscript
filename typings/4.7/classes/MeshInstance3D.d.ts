...
declare class MeshInstance3D extends GeometryInstance3D {
   ...
   */
  bake_mesh_from_current_blend_shape_mix(existing?: ArrayMesh): ArrayMesh | null;
  /**
   ...
   */
  bake_mesh_from_current_skeleton_pose(existing?: ArrayMesh): ArrayMesh | null;
  /**
   ...
   */
  get_active_material(surface: int): Material | null;
   ...
   */
  get_skin_reference(): SkinReference | null;
  /**
   ...
   */
  get_surface_override_material(surface: int): Material | null;
  /**

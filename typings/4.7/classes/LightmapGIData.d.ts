...
declare class LightmapGIData extends Resource {
  ...
  set_light_texture(value: TextureLayered): void;
  get_light_texture(): TextureLayered;
  set_lightmap_textures(value: unknown): void;
  get_lightmap_textures(): unknown;
  set_shadowmask_textures(value: unknown): void;
  get_shadowmask_textures(): unknown;

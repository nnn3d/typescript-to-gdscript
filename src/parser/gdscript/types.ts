...
export interface GDEnumeratorNode extends GDNodeBase {
  ...
  childForFieldName(name: 'right'): (GDAttributeNode | GDBinaryOperatorNode | GDCallNode | GDIdentifierNode | GDIntegerNode | GDParenthesizedExpressionNode | GDSubscriptNode | GDUnaryOperatorNode) | null;
  childForFieldName(name: string): GDNode | null;
}
...
export interface GDIfStatementNode extends GDNodeBase {
  type: "if_statement";
  childForFieldName(name: 'alternative'): (GDElifClauseNode | GDElseClauseNode)[];
  childForFieldName(name: 'body'): GDBodyNode;
  childForFieldName(name: 'condition'): GDExpressionUnion;
  childForFieldName(name: string): GDNode | null;
}
...
export interface GDPairNode extends GDNodeBase {
  type: "pair";
  childForFieldName(name: 'left'): (GDExpressionUnion | GDIdentifierNode | GDLambdaNode);
  childForFieldName(name: 'value'): (GDExpressionUnion | GDLambdaNode | GDPatternBindingNode);
  childForFieldName(name: string): GDNode | null;
}
...
export type GDAttributeExpressionUnion = GDArrayNode | GDBaseCallNode | GDBinaryOperatorNode | GDCallNode | GDDictionaryNode | GDFalseNode | GDFloatNode | GDGetNodeNode | GDIdentifierNode | GDIntegerNode | GDNodePathNode | GDNullNode | GDParenthesizedExpressionNode | GDStringNode | GDSubscriptNode | GDTrueNode | GDUnaryOperatorNode;

export type GDCompoundStatementUnion = GDClassDefinitionNode | GDConstructorDefinitionNode | GDEnumDefinitionNode | GDForStatementNode | GDFunctionDefinitionNode | GDIfStatementNode | GDMatchStatementNode | GDWhileStatementNode;

export type GDExpressionUnion = GDPrimaryExpressionUnion | GDConditionalExpressionNode;

export type GDParametersUnion = GDDefaultParameterNode | GDIdentifierNode | GDTypedDefaultParameterNode | GDTypedParameterNode | GDVariadicParameterNode;

export type GDPatternUnion = GDPrimaryExpressionUnion | GDConditionalExpressionNode | GDPatternBindingNode;

export type GDPrimaryExpressionUnion = GDArrayNode | GDAttributeNode | GDAwaitExpressionNode | GDBaseCallNode | GDBinaryOperatorNode | GDCallNode | GDDictionaryNode | GDFalseNode | GDFloatNode | GDGetNodeNode | GDIdentifierNode | GDIntegerNode | GDNodePathNode | GDNullNode | GDParenthesizedExpressionNode | GDStringNode | GDStringNameNode | GDSubscriptNode | GDTrueNode | GDUnaryOperatorNode;

/** Union of all GDScript AST node types */
export type GDNode = GDAnnotationNode | GDAnnotationsNode | GDArgumentsNode | GDArrayNode | GDAssignmentNode | GDAttributeNode | GDAttributeCallNode | GDAttributeSubscriptNode | GDAugmentedAssignmentNode | GDAwaitExpressionNode | GDBaseCallNode | GDBinaryOperatorNode | GDBodyNode | GDBreakStatementNode | GDCallNode | GDClassBodyNode | GDClassDefinitionNode | GDClassNameStatementNode | GDConditionalExpressionNode | GDConstStatementNode | GDConstructorDefinitionNode | GDContinueStatementNode | GDDefaultParameterNode | GDDictionaryNode | GDElifClauseNode | GDElseClauseNode | GDEnumDefinitionNode | GDEnumeratorNode | GDEnumeratorListNode | GDExportVariableStatementNode | GDExpressionStatementNode | GDExtendsStatementNode | GDForStatementNode | GDFunctionDefinitionNode | GDGetBodyNode | GDGetNodeNode | GDGetterNode | GDIdentifierNode | GDIfStatementNode | GDInferredTypeNode | GDLambdaNode | GDMatchBodyNode | GDMatchStatementNode | GDNameNode | GDNodePathNode | GDOnreadyVariableStatementNode | GDPairNode | GDParametersNode | GDParenthesizedExpressionNode | GDPassStatementNode | GDPatternBindingNode | GDPatternGuardNode | GDPatternSectionNode | GDRegionStartNode | GDRemoteKeywordNode | GDReturnStatementNode | GDSetBodyNode | GDSetgetNode | GDSetterNode | GDSignalStatementNode | GDSourceNode | GDStringNode | GDStringNameNode | GDSubscriptNode | GDSubscriptArgumentsNode | GDTypeNode | GDTypedDefaultParameterNode | GDTypedParameterNode | GDUnaryOperatorNode | GDVariableStatementNode | GDVariadicParameterNode | GDWhileStatementNode | GDBreakpointStatementNode | GDCommentNode | GDEscapeSequenceNode | GDFalseNode | GDFloatNode | GDIntegerNode | GDLineContinuationNode | GDNullNode | GDPatternOpenEndingNode | GDRegionEndNode | GDRegionLabelNode | GDStaticKeywordNode | GDTrueNode;

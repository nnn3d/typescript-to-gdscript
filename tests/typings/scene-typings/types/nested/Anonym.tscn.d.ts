...
type _nested_AnonymTscn_Tree = {
  [__node_root]: "Player";
  [__node_type]: _GDGetInterfaceNode<GodotScripts, "res://nested/Anonym.gd">;
...
declare global {
  ...
  interface GodotScenes {
    "res://nested/Anonym.tscn": _GDTreeNode<_nested_AnonymTscn_Tree>;
  }
  interface GodotResources {
    "res://nested/Anonym.tscn": PackedScene<_GDTreeNode<_nested_AnonymTscn_Tree>>;
    "uid://test_nested_anonym_scene": PackedScene<_GDTreeNode<_nested_AnonymTscn_Tree>>;
  }
}
